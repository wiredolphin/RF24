...
s   *
  ...
  int getDetails(char * buffer, int max_len);
  void get_byte_register(char * buff, uint8_t reg, uint8_t qty = 1);
  void get_address_register(char * buff, uint8_t reg, uint8_t qty = 1);
